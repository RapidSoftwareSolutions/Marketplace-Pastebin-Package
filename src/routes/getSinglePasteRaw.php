...
$app->post('/api/Pastebin/getSinglePasteRaw', function ($request, $response) {
    /** @var \Slim\Http\Response $response */
    /** @var \Slim\Http\Request $request */
    /** @var \Models\checkRequest $checkRequest */

    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['pasteKey']);
    ...
    $url = "https://pastebin.com/raw/" . $postData['args']['pasteKey'];
