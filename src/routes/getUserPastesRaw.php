...
$app->post('/api/Pastebin/getUserPastesRaw', function ($request, $response) {
    ...
    $validateRes = $checkRequest->validate($request, ['apiDevKey', 'apiUserKey', 'pasteKey']);
